...
export default function Contact({ onOpenChat }: ContactProps) {
  ...
  return (
    <section id="contact" className="py-24 relative bg-black overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] rounded-full blur-[160px] pointer-events-none opacity-40"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16 space-y-3">
          ...
          <p className="text-gray-400 max-w-2xl text-base sm:text-lg leading-relaxed font-normal">
            Let&apos;s build something modern, useful, and impactful together.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 sm:p-7 space-y-4">
              ...
              <p className="text-xs sm:text-sm text-gray-300 leading-relaxed">
                Whether you have an open engineering position, a freelance web
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.03] hover:border-white/25 p-4 flex items-center justify-between group transition-colors"
              >
            ...
            {onOpenChat && (
              <button
                type="button"
                onClick={onOpenChat}
                className="w-full rounded-2xl p-4 flex items-center justify-between text-left group border transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="lg:col-span-7 rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 sm:p-8 relative"
          >
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-black/60 border border-white/10 focus:border-[#ccff00] focus:ring-1 focus:ring-[#ccff00] text-white placeholder-gray-600 text-sm outline-none transition-colors"
                    />
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-black/60 border border-white/10 focus:border-[#ccff00] focus:ring-1 focus:ring-[#ccff00] text-white placeholder-gray-600 text-sm outline-none transition-colors resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl text-sm font-bold uppercase tracking-wide text-black transition-all duration-300 active:scale-[0.98] disabled:opacity-50"
                  style={{ backgroundColor: ACCENT }}
                >
                  {isSubmitting ? (
